...
Nous proposons un outil permettant d'éviter de forcer ce changement d'architecture en proposant d'automatiser un changement de paradigme dans les programmes, sans en modifier le code d'origine.
