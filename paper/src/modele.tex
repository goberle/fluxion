...
\State $message \gets$ \Call{exec}{$fluxion, msg.body$} \Comment{étape \circled{4} \& \circled{5}}
\State \Call{enqueue}{$message$} \Comment{étape \circled{6}}
\EndFor
\EndFunction
\end{algorithmic}
\end{algorithm}
